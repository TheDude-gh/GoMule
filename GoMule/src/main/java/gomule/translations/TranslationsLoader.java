...
import static gomule.files.FileReaderUtils.getResourceJSON;;

public class TranslationsLoader {

    public static Translations loadTranslations() {
        return new CompositeTranslations(
                MapBasedTranslations.loadTranslations(getResourceJSON("d2strings.json")),
                MapBasedTranslations.loadTranslations(getResourceJSON("d2strings_custom.json"))
                //MapBasedTranslations.loadTranslations(getResource("d2Files/D2R_3.0/translations/d2string.json"))
