                    ...
                    for (int t = 0; t < 10; t = t + 1) {
                        if ((pVals[0] - (getCharCode() * 8)) > -1 && (pVals[0] - (getCharCode() * 8)) < 4) {
                            if (cSkills[pVals[0] - (getCharCode() * 8)][t] > 0)
                                cSkills[pVals[0] - (getCharCode() * 8)][t] = cSkills[pVals[0] - (getCharCode() * 8)][t] + pVals[1];
                        }
                    }
            }
        }
...
//		return 0;
    ...
    public int getMercInitDex() {
        return (int) Math.floor((Integer.parseInt(mercHireCol.get("Dex")) + ((Double.parseDouble(mercHireCol.get("Dex/Lvl")) / (double) 8) * (getMercLevel() - Integer.parseInt(mercHireCol.get("Level"))))));
    }

    public int getMercInitHP() {
        return (int) Math.floor((Integer.parseInt(mercHireCol.get("HP")) + ((Double.parseDouble(mercHireCol.get("HP/Lvl"))) * (getMercLevel() - Integer.parseInt(mercHireCol.get("Level"))))));
    }

    public long getMercInitDef() {
        return (long) (Math.floor((double) getMercInitDex() / (double) 4) + Integer.parseInt(mercHireCol.get("Defense")) + (Integer.parseInt(mercHireCol.get("Def/Lvl")) * (getMercLevel() - Integer.parseInt(mercHireCol.get("Level")))));
    }

    public int getMercInitAR() {
        return ((getMercInitDex() * 5) - 35) + (int) Math.floor((Integer.parseInt(mercHireCol.get("AR")) + ((Double.parseDouble(mercHireCol.get("AR/Lvl")) / (double) 8) * (getMercLevel() - Integer.parseInt(mercHireCol.get("Level"))))));
    }
    ...
    public int getMercAR() {
        return (((getMercInitDex() * 5) - 35) + (int) Math.floor((Integer.parseInt(mercHireCol.get("AR")) + ((Double.parseDouble(mercHireCol.get("AR/Lvl")) / (double) 8) * (getMercLevel() - Integer.parseInt(mercHireCol.get("Level")))))) + mStats[14] + mStats[16]) * (1 + mStats[15] + mStats[17]);
    }
